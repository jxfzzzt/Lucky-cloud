...
/**
 * 用户 -> 多设备Channel 管理
 * - 同组设备互斥 IMDeviceType.isConflicting 决定
 * - 新连接会替换冲突或相同类型的旧连接并优雅关闭旧连接 * - Channel.closeFuture 注册幂等清理
 */
...
public class UserChannelMap {
    ...
    /**
     * 根据 Channel 实例清理资源 (通常由closeFuture 触发)
     */
    public void removeByChannel(Channel channel) {
        ...
        if (userId != null && type != null) {
            ...
            if (im != null) {
                ...
                // 只有 Map 中的 Channel ID 与当前关闭的一致时才移除，防止误删新连接
